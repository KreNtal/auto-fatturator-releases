...
Esegui l'installer scaricato: l'app si installa per l'utente corrente (nessun privilegio di amministratore richiesto) e crea una voce nel menù Start.

## Aggiornamenti

L'app verifica automaticamente la presenza di nuove versioni pubblicate qui e propone di scaricarle e installarle.
